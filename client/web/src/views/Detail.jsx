          ...
          >
            <div className="card">
              ...
              >
                ...
                >
                  <h2 class="mb-5 text-2xl font-bold">{reportDetail.title}</h2>
                  <div>
                    <div
                      class="card-image"
                      style={{
                    ...
                    <div class="justify-between grid grid-cols-2 mt-3">
                      ...
                      <div class="ml-3">
                        <h1 class="mb-2 text-l text-right">
                    ...
                    >
                        ...
                        <div class="mr-3">
                          <div class="mb-6">
                            <select
                              ...
                              onChange={forStatus}
                            >
                              <option value={reportDetail.status}>
                                {reportDetail.status}
                              </option>
                      ...
                      >
                        ...
                        <div class="mt-8">
                          ...
                          {!reportDetail.finished_date ? (
                            <p
                              class="text-xl text-justify mt-2"
                              style={{ width: "100%" }}
                            >
                              Belum diproses
                            </p>
                            ...
                            <p
                              ...
                              style={{ width: "100%" }}
                            >
                              {getFormatedDate(reportDetail.finished_date)}
                            </p>
                          )}
                        </div>
                      </div>
