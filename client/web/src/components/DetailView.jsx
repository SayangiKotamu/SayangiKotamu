...
function DetailView(props) {
  return (
    ...
    >
      ...
      >
        <h2 class="mb-5 text-2xl font-bold">{props.report.title}</h2>
        <div>
          <div
            class="card-image"
            style={{
          ...
          <div class="justify-between grid grid-cols-2">
            <div class="mr-3">
              <button class="btn btn-square btn-ghost mt-2">
                ...
                <h1 class="text-l font-bold text-right ml-1">
                  {props.report.upVote}
                </h1>
              </button>
            </div>
            <div style={{ marginLeft: "80%" }}>
              <button class="btn btn-square btn-ghost mt-2">
                ...
                <h1 class="mb-2 mr-2 ml-1 text-l font-bold text-right">
                  {props.report.downVote}
                </h1>
              </button>
            </div>
          </div>
          ...
          <div class="justify-between grid grid-cols-2 mt-3">
            ...
            <div class="ml-3">
              <h1 class="mb-2 text-l text-right">{props.report.location}</h1>
            </div>
          </div>
        </div>
      </div>
